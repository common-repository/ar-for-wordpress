...
class ar_for_wordpress_widget extends WP_Widget {
    ...
    public function form( $instance ) {
        ...
        ?>
        <p>
        <label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php echo esc_html(__( 'Title:', 'ar-for-wordpress' )); ?></label>
        <input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'title' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'title' )); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
        <label for="<?php echo esc_attr($this->get_field_id( 'ar_id' )); ?>"><?php echo esc_html(__( 'AR Model:', 'ar-for-wordpress' )); ?></label>
        <select class="widefat" id="<?php echo esc_attr($this->get_field_id( 'ar_id' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'ar_id' )); ?>">
            <?php
            $args = array(
                'post_type'=> 'armodels',
                'orderby'        => 'title',
